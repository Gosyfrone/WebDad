	...
	"notifications": {
		"$jsonSchema": bson.M{
			...
			"properties": bson.M{
				...
				"type":            bson.M{"bsonType": "string", "enum": bson.A{"like", "comment", "reply", "mention", "repost", "quote", "follow", "message", "message_mention", "follow_request", "follow_request_accepted", "follow_request_accept_confirm", "post_purge_warning"}},
