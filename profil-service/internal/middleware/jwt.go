// Package middleware contient les middlewares Gin du service profil.
package middleware
...
// profil-service ne signe pas de token, il se contente de les VALIDER avec
...
// OptionalJWTAuth injecte les claims si un Bearer valide est présent, sans
// bloquer les lectures publiques anonymes.
