...
| User profile | Primary | 🟡 View + edit + by-username page, visibility configurable in settings, private-account locking, real avatar/banner upload. **TODO:** wire aggregated user+profil+post read. |
