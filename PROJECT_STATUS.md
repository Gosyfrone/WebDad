...
| Search / Explorer (accounts + hashtags) | Secondary | 🟢 user + profil search by `@username`, plain username, or display_name; direct `#hashtag` navigation; hashtag page dropdown suggests trends then profiles; "Who to follow"; per-account local search history. **TODO:** post full-text search. |
