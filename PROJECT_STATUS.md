...
| Hashtags & trends | Secondary | 🟢 End-to-end: hashtags extracted server-side on posts, clickable render, `?hashtag=` feed filter, and dynamic trends from visible posts. |
