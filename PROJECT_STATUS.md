...
| Post creation/reading | Primary | 🟢 End-to-end, infinite feed (For you / Following), hashtag filter, visibility-filtered, likes, threaded comments, reposts/quotes, pin, emoji, images/videos, **polls (choices, duration, everyone/followers audience, vote, author-only live results, manual close + winner display)**. **TODO:** post edit. |
