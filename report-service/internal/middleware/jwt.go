// Package middleware contient les middlewares Gin du report-service.
package middleware
...
// est un sur-ensemble du modérateur). À chaîner APRÈS JWTAuth. 403 sinon.
// Garde les routes de gestion des tickets et des avertissements.
...
// Garde le transfert d'un ticket bug → modération (gouvernance admin). 403 sinon.
