...
func respondError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrNotBug), errors.Is(err, service.ErrAlreadyReported), errors.Is(err, service.ErrReportingLocked), errors.Is(err, service.ErrAlreadyActioned):
