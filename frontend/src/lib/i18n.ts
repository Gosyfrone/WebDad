...
export const messages: Record<Locale, Messages> = {
  fr: {
    ...
    'messages.copy_invite_link': "Copier le lien d'invitation",
    'messages.invite_link_copied': "Lien d'invitation copié",
  ...
  en: {
    ...
    'messages.copy_invite_link': 'Copy invite link',
    'messages.invite_link_copied': 'Invite link copied',
