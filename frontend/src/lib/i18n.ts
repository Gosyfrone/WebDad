...
export const messages: Record<Locale, Messages> = {
  fr: {
    ...
    'voice.record': 'Message vocal',
    'voice.send': 'Envoyer le vocal',
    'voice.cancel': 'Annuler le vocal',
    'voice.slide_to_cancel': 'Glissez pour annuler',
    'voice.release_to_cancel': 'Relâchez pour annuler',
    'voice.permission_denied': "Accès au micro refusé. Autorisez-le pour enregistrer un vocal.",
    ...
    'auth.register.err.username_max':
      "Le nom d'utilisateur est limité à 24 caractères.",
    'auth.register.err.username_reserved':
    ...
    'onboarding.username_hint':
      '3 à 24 caractères : lettres, chiffres et tiret bas (_).',
  ...
  en: {
    ...
    'voice.cancel': 'Cancel voice message',
    'voice.slide_to_cancel': 'Slide to cancel',
    'voice.release_to_cancel': 'Release to cancel',
    'voice.permission_denied': 'Microphone access denied. Allow it to record a voice message.',
    'messages.back': 'Back',
    ...
    'onboarding.username_hint':
      '3 to 24 characters: letters, numbers and underscore (_).',
