...
export const messages: Record<Locale, Messages> = {
  fr: {
    ...
    'certification.assign': 'Attribuer une certification',
    'certification.political': 'Politique',
    'certification.public_figure': 'Personnalité publique',
    'certification.staff': 'Staff',
    'certification.option.political': 'Politique',
    'certification.option.public_figure': 'Personnalité publique',
    'certification.option.none': 'Retirer la certification',
    ...
    'tutorial.step_counter': '{current} / {total}',
    'tutorial.step.welcome.title': 'Bienvenue sur Breezy 👋',
    'tutorial.step.welcome.body': 'Faisons un tour rapide des fonctionnalités. Cliquez sur « Suivant », ou sur l’élément en surbrillance. Vous pouvez ignorer à tout moment.',
    'tutorial.step.feed.title': 'Le fil',
    'tutorial.step.feed.body': 'Votre fil d’actualité : les posts des comptes que vous suivez et les tendances. C’est votre page d’accueil.',
    'tutorial.step.explorer.title': 'Explorer',
    'tutorial.step.explorer.body': 'Recherchez des comptes, des hashtags et des posts, et découvrez ce qui circule sur Breezy.',
    'tutorial.step.notifications.title': 'Notifications',
    'tutorial.step.notifications.body': 'Likes, reposts, réponses, nouveaux abonnés et mentions vous attendent ici. La pastille indique les non-lues.',
    'tutorial.step.messages.title': 'Messages',
    'tutorial.step.messages.body': 'Vos discussions privées, chiffrées de bout en bout. Échangez en tête-à-tête ou en groupe.',
    'tutorial.step.bookmarks.title': 'Signets',
    'tutorial.step.bookmarks.body': 'Enregistrez les posts à relire plus tard et organisez-les en collections.',
    'tutorial.step.profil.title': 'Votre profil',
    'tutorial.step.profil.body': 'Votre page publique : photo, bannière, bio et vos posts. Personnalisez-la pour qu’on vous reconnaisse.',
    'tutorial.step.compose.title': 'Publier',
    'tutorial.step.compose.body': 'Partagez une pensée, une image, un sondage… Ce bouton ouvre la fenêtre de publication.',
    'tutorial.step.help.title': 'Besoin d’aide ?',
    'tutorial.step.help.body': 'Retrouvez ce didacticiel et la page d’aide à tout moment via ce bouton lampe. C’est terminé, bonne visite !',

    // — Aide —
    'help.menu_aria': 'Aide et didacticiel',
    'help.page_link': 'Page d’aide',
    'help.replay_tutorial': 'Didacticiel',
    'help.title': 'Aide',
    'help.subtitle': 'Comment utiliser chaque section de Breezy.',
    'help.sections_title': 'Les sections de Breezy',
    'help.tutorial_title': 'Revoir le didacticiel',
    'help.tutorial_desc': 'Relancez la visite guidée depuis le début.',
    'help.section.feed.title': 'Le fil',
    'help.section.feed.body': 'Votre page d’accueil : les posts des comptes suivis et les tendances. Aimez, répondez, repostez, ou publiez à votre tour.',
    'help.section.explorer.title': 'Explorer',
    'help.section.explorer.body': 'Recherchez des comptes, des hashtags et des posts. Filtrez les résultats et découvrez les tendances du moment.',
    'help.section.notifications.title': 'Notifications',
    'help.section.notifications.body': 'Toutes vos interactions : likes, reposts, réponses, mentions et nouveaux abonnés. La pastille compte les non-lues.',
    'help.section.messages.title': 'Messages',
    'help.section.messages.body': 'Vos conversations privées, chiffrées de bout en bout. Discutez en privé ou créez des groupes.',
    'help.section.bookmarks.title': 'Signets',
    'help.section.bookmarks.body': 'Les posts que vous enregistrez pour plus tard, rangés en collections que vous nommez.',
    'help.section.profil.title': 'Profil',
    'help.section.profil.body': 'Votre vitrine publique : avatar, bannière, bio et historique de posts. Modifiez-la depuis le bouton d’édition.',
    'help.section.parametres.title': 'Paramètres',
    'help.section.parametres.body': 'Langue, thème, confidentialité, contenu sensible, comptes bloqués, sécurité du compte… tout se règle ici.',
  },
  en: {
    // — Common —
    'common.user': 'User',
    ...
    'certification.assign': 'Assign certification',
    'certification.political': 'Political figure',
    'certification.public_figure': 'Public figure',
    'certification.staff': 'Staff',
    'certification.option.political': 'Political figure',
    'certification.option.public_figure': 'Public figure',
    'certification.option.none': 'Remove certification',
    ...
    'tutorial.step_counter': '{current} / {total}',
    'tutorial.step.welcome.title': 'Welcome to Breezy 👋',
    'tutorial.step.welcome.body': 'Let’s take a quick tour of the features. Click “Next”, or the highlighted element. You can skip anytime.',
    'tutorial.step.feed.title': 'The feed',
    'tutorial.step.feed.body': 'Your timeline: posts from the accounts you follow, plus what’s trending. This is your home page.',
    'tutorial.step.explorer.title': 'Explore',
    'tutorial.step.explorer.body': 'Search for accounts, hashtags and posts, and discover what’s buzzing on Breezy.',
    'tutorial.step.notifications.title': 'Notifications',
    'tutorial.step.notifications.body': 'Likes, reposts, replies, new followers and mentions all land here. The badge shows unread ones.',
    'tutorial.step.messages.title': 'Messages',
    'tutorial.step.messages.body': 'Your private chats, end-to-end encrypted. Talk one-on-one or in groups.',
    'tutorial.step.bookmarks.title': 'Bookmarks',
    'tutorial.step.bookmarks.body': 'Save posts to read later and organize them into collections.',
    'tutorial.step.profil.title': 'Your profile',
    'tutorial.step.profil.body': 'Your public page: photo, banner, bio and your posts. Personalize it so people recognize you.',
    'tutorial.step.compose.title': 'Post',
    'tutorial.step.compose.body': 'Share a thought, an image, a poll… This button opens the composer.',
    'tutorial.step.help.title': 'Need help?',
    'tutorial.step.help.body': 'Find this tutorial and the help page anytime via this lightbulb button. That’s it — enjoy!',

    // — Help —
    'help.menu_aria': 'Help and tutorial',
    'help.page_link': 'Help page',
    'help.replay_tutorial': 'Tutorial',
    'help.title': 'Help',
    'help.subtitle': 'How to use each section of Breezy.',
    'help.sections_title': 'Breezy’s sections',
    'help.tutorial_title': 'Replay the tutorial',
    'help.tutorial_desc': 'Restart the guided tour from the beginning.',
    'help.section.feed.title': 'The feed',
    'help.section.feed.body': 'Your home page: posts from accounts you follow and trending topics. Like, reply, repost, or post your own.',
    'help.section.explorer.title': 'Explore',
    'help.section.explorer.body': 'Search for accounts, hashtags and posts. Filter the results and discover what’s trending.',
    'help.section.notifications.title': 'Notifications',
    'help.section.notifications.body': 'All your interactions: likes, reposts, replies, mentions and new followers. The badge counts unread ones.',
    'help.section.messages.title': 'Messages',
    'help.section.messages.body': 'Your private conversations, end-to-end encrypted. Chat privately or create groups.',
    'help.section.bookmarks.title': 'Bookmarks',
    'help.section.bookmarks.body': 'Posts you save for later, sorted into collections you name yourself.',
    'help.section.profil.title': 'Profile',
    'help.section.profil.body': 'Your public showcase: avatar, banner, bio and post history. Edit it from the edit button.',
    'help.section.parametres.title': 'Settings',
    'help.section.parametres.body': 'Language, theme, privacy, sensitive content, blocked accounts, account security… set it all here.',
  },
  ...additionalMessages,
}
