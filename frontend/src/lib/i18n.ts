...
export const messages: Record<Locale, Messages> = {
  fr: {
    ...
    'bookmarks.save_to': 'Ranger dans une playlist',
    ...
    'bookmarks.new_playlist': 'Nouvelle playlist',
    'bookmarks.new_playlist_placeholder': 'Nom de la playlist',
    'bookmarks.create': 'Créer',
    'bookmarks.no_playlists': 'Aucune playlist pour le moment.',
    'bookmarks.manage': 'Gérer la playlist',
    'bookmarks.rename': 'Renommer',
    'bookmarks.delete': 'Supprimer',
    'bookmarks.delete_title': 'Supprimer la playlist',
    'bookmarks.delete_confirm': 'Les posts ne seront plus dans cette playlist (ils restent publiés).',
    'bookmarks.empty_title': 'Aucun signet',
    'bookmarks.empty_message': 'Enregistrez des posts pour les retrouver ici.',
    'bookmarks.empty_playlist': 'Cette playlist est vide.',
  ...
  en: {
    ...
    'bookmarks.save': 'Save',
    'bookmarks.save_to': 'Save to a playlist',
    ...
    'bookmarks.new_playlist': 'New playlist',
    'bookmarks.new_playlist_placeholder': 'Playlist name',
    'bookmarks.create': 'Create',
    'bookmarks.no_playlists': 'No playlist yet.',
    'bookmarks.manage': 'Manage playlist',
    'bookmarks.rename': 'Rename',
    'bookmarks.delete': 'Delete',
    'bookmarks.delete_title': 'Delete playlist',
    'bookmarks.delete_confirm': 'Posts will leave this playlist (they stay published).',
    'bookmarks.empty_title': 'No bookmarks',
    'bookmarks.empty_message': 'Save posts to find them here.',
    'bookmarks.empty_playlist': 'This playlist is empty.',
