...
export const messages: Record<Locale, Messages> = {
  fr: {
    ...
    'editprofil.name_invalid': 'Utilisez uniquement des lettres, chiffres, espaces, tirets ou underscores.',
  ...
  en: {
    ...
    'editprofil.name_invalid': 'Use only letters, numbers, spaces, hyphens or underscores.',
