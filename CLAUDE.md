...
> - Latest session note: 12/06/2026 — Admin account creation (forced) + temporary-password / provisional-username blocking gates across auth/user/profil; feed right-sidebar `Qui suivre` now shows full display names in compact mode; details in `CHANGELOG.md`.
