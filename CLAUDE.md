...
> - Latest session note: 12/06/2026 — Réponses profil en vue conversation (post parent complet + réponse en dessous) et clic notif commentaire/réponse → deep-link `?comment=` qui défile/surligne le commentaire ; details in `CHANGELOG.md`.
