...
| Post creation/reading | Primary | 🟢 De bout en bout (cf. Post Service + §5). Feed défilement infini (Pour toi / Abonnements) sans divulguer les pins d'autrui, like optimiste animé, commentaires threadés 2 niveaux, reposts/citations, épinglage visible sur profil, emoji. `lib/posts.ts` cache auteur. TODO : édition post, upload images. |
